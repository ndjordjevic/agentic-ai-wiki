...
If you ask questions from **another repo** but want agents to use this wiki, add that instruction there—in `CLAUDE.md` or `AGENTS.md`—to consult this wiki’s `wiki/index.md` (and follow `[[wikilinks]]`) for **Agentic AI Frameworks**.
