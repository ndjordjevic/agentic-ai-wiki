...
- Fetched: 2026-07-08
- Final URL: https://github.com/headroomlabs-ai/headroom
- Inbox URL: https://github.com/chopratejas/headroom
...
| Path | Notes |
|------|-------|
| `headroom/` | Main Python package — core orchestration, CLI, proxy, providers |
| `crates/` | Rust crates for performance-critical compression paths |
| `sdk/typescript/` | TypeScript SDK (`headroom-ai` npm package) |
| `docs/` | MkDocs documentation source |
| `examples/` | Integration examples |
| `benchmarks/` | Compression benchmarks and eval suites |
| `agent-evals/` | Agent evaluation harnesses |
| `plugins/` | Agent tool plugins (Claude, Codex, etc.) |
| `wiki/` | In-repo wiki content |
| `docker/` | Docker build assets |
| `e2e/` | End-to-end tests |
| `tests/` | Test suite |
| `.claude-plugin/` | Claude Code plugin manifest |
| `.devcontainer/` | Devcontainer configs (default + memory-stack) |
| `pyproject.toml` / `Cargo.toml` | Python + Rust workspace roots |
| `llms.txt` | LLM-oriented docs index |
| `mkdocs.yml` | Docs site configuration |

## Examples (structure only)

07-context-compression.ipynb, README.md, context_compression_demo.py, deployment, langchain_demo, mcp_demo, strands_bedrock_demo.py, strands_bundle_demo.py, strands_mcp_dispatch_test.py, strands_via_proxy_demo.py, tabular_compression_demo.py, test_ccr.py