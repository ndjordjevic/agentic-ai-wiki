...
- Default branch: main
- Latest release: @ai-sdk/workflow-harness@1.0.46 (2026-07-28)
- License: Other (see repo LICENSE)
- Homepage: https://ai-sdk.dev
- Fetched: 2026-07-28
- Final URL: https://github.com/vercel/ai
...
If you use coding agents such as Claude Code or Cursor, it's recommended to add the AI SDK skill to your repository:
...
The AI SDK provides a unified API (https://ai-sdk.dev/docs/foundations/providers-and-models) to interact with model providers like OpenAI, Anthropic, Google, and more (https://ai-sdk.dev/providers/ai-sdk-providers).

By default, the AI SDK uses the Vercel AI Gateway (https://vercel.com/docs/ai-gateway) to give access to all major providers out of the box. Just pass a model string for any supported model:
...
The AI SDK UI module (https://ai-sdk.dev/docs/ai-sdk-ui/overview) provides a set of hooks that help you build chatbots and generative user interfaces. These hooks are framework agnostic, so they can be used in Next.js, React, Svelte, and Vue.
...
Vercel provides templates (https://ai-sdk.dev/docs/introduction#templates) that include AI SDK integrations for different use cases, providers, and frameworks.
...
Contributions to the AI SDK are welcome. Review the Contribution Guidelines (https://github.com/vercel/ai/blob/main/CONTRIBUTING.md) before contributing.

## Authors

This library is created by Vercel and Next.js team members, with contributions from the Open Source Community (https://github.com/vercel/ai/graphs/contributors).

## Top-level structure

Not fetched in detail at `standard` companion-fetch depth — README and metadata are the primary source for this ingest. The README's package examples (`@ai-sdk/openai`, `@ai-sdk/anthropic`, `@ai-sdk/google`, `@ai-sdk/react`, `@ai-sdk/devtools`, `@ai-sdk/workflow-harness`) indicate a monorepo of scoped `@ai-sdk/*` packages published alongside the core `ai` package.
