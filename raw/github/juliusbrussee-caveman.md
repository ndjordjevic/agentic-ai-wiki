...
- Default branch: main
- Latest release: v1.9.0 (2026-06-12)
- License: MIT License
- Homepage: https://caveman.so/
- Fetched: 2026-07-01
- Final URL: https://github.com/JuliusBrussee/caveman
...
### INSTALL.md (excerpt — agent matrix and flags)
# Install caveman
...
- `skills/` — caveman skill definitions (`/caveman`, `/caveman-commit`, `/caveman-review`, `/caveman-stats`, `/caveman-compress`)
- `commands/` — slash command implementations
- `agents/` — cavecrew subagents (investigator/builder/reviewer)
- `bin/install.js` — unified installer with PROVIDERS matrix for 30+ agents
- `public/engine/` — Go compression engine (BSL)
- `public/proxy/` — byte-safe reverse proxy (BSL)
- `benchmarks/` — token reduction benchmark data
- `evals/` — three-arm eval harness (baseline / terse / skill)
- `docs/` — GitHub Pages docs assets
- `install.sh` / `install.ps1` — one-line installers
- `CLAUDE.md` — maintainer architecture notes
