...
## Metadata
- Stars: 22658
- Primary language: N/A (markdown/plugin manifests)
- Default branch: main
- Latest release: v2.1.0 (2026-07-03)
- License: MIT License
- Homepage: https://www.productcompass.pm/p/pm-skills-2-red-team-ship
- Fetched: 2026-07-06
- Final URL: https://github.com/phuryn/pm-skills
...
## Top-level structure
Annotated directory listing from GitHub API:

- `.claude-plugin/` (dir) — root marketplace manifest (marketplace.json lists all 9 plugins)
- `.docs/` (dir) — README images (webp, gif)
- `.gitattributes` (file) — standard repo file
- `.github/` (dir) — CI workflows (tests.yml, tag-on-merge.yml)
- `.gitignore` (file) — standard repo file
- `AGENTS.md` (file) — agent instruction files
- `CHANGELOG.md` (file) — standard repo file
- `CLAUDE.md` (file) — agent instruction files
- `CONTRIBUTING.md` (file) — standard repo file
- `LICENSE` (file) — standard repo file
- `README.md` (file) — standard repo file
- `pm-ai-shipping/` (dir) — plugin directory (skills/, commands/, .claude-plugin/plugin.json, README.md)
- `pm-data-analytics/` (dir) — plugin directory (skills/, commands/, .claude-plugin/plugin.json, README.md)
- `pm-execution/` (dir) — plugin directory (skills/, commands/, .claude-plugin/plugin.json, README.md)
- `pm-go-to-market/` (dir) — plugin directory (skills/, commands/, .claude-plugin/plugin.json, README.md)
- `pm-market-research/` (dir) — plugin directory (skills/, commands/, .claude-plugin/plugin.json, README.md)
- `pm-marketing-growth/` (dir) — plugin directory (skills/, commands/, .claude-plugin/plugin.json, README.md)
- `pm-product-discovery/` (dir) — plugin directory (skills/, commands/, .claude-plugin/plugin.json, README.md)
- `pm-product-strategy/` (dir) — plugin directory (skills/, commands/, .claude-plugin/plugin.json, README.md)
- `pm-toolkit/` (dir) — plugin directory (skills/, commands/, .claude-plugin/plugin.json, README.md)
- `tests/` (dir) — unit + docs-consistency tests (unittest)
- `validate_plugins.py` (file) — plugin validator script
