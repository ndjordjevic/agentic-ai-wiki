...
- Latest release: v2026.626.0 (2026-06-27)
- License: MIT
...
docs/                 Documentation site source (Diataxis-style guides, API reference, adapters)
...
server/               Express REST API and orchestration services
skills/               Built-in skills (paperclip heartbeat, paperclip-dev, paperclip-create-agent, paperclip-create-plugin, para-memory-files)
tests/                Test suites
