...
## Metadata
- Stars: 95082
- Primary language: (none — markdown/design assets)
- Default branch: main
- Latest release: none
- License: MIT License
- Homepage: https://github.com/VoltAgent/voltagent
- Fetched: 2026-07-02
- Final URL: https://github.com/VoltAgent/awesome-design-md
...
### Sample DESIGN.md structure (design-md/linear.app/DESIGN.md excerpt)

Each brand folder under `design-md/` contains a `DESIGN.md` with YAML frontmatter and structured token blocks:

```yaml
---
version: alpha
name: Linear-design-analysis
description: "A near-black product-focused marketing canvas built around #010102..."
colors:
  primary: "#5e6ad2"
  on-primary: "#ffffff"
  canvas: "#010102"
...
The full file continues with component rules, layout principles, do's/don'ts, responsive behavior, and an agent prompt guide per the Stitch DESIGN.md specification.

## Top-level structure

```
.github/          — GitHub Actions / community templates (boilerplate)
.gitignore
CONTRIBUTING.md   — contribution policy; new DESIGN.md PRs not accepted
LICENSE           — MIT
README.md         — Awesome-list catalog (73+ brands, categorized)
design-md/        — 74 brand directories, each containing:
                    DESIGN.md     — agent-readable design system (primary artifact)
                    README.md     — brand-specific notes
                    (preview.html / preview-dark.html referenced in README but
                     not present in all repo folders — served via getdesign.md CDN)
```

Brand folders include: airbnb, airtable, apple, binance, bmw, bmw-m, bugatti, cal, claude, clay, clickhouse, cohere, coinbase, composio, cursor, dell-1996, elevenlabs, expo, ferrari, figma, framer, hashicorp, hp, ibm, intercom, kraken, lamborghini, linear.app, lovable, mastercard, meta, minimax, mintlify, miro, mistral.ai, mongodb, nike, nintendo-2001, notion, nvidia, ollama, opencode.ai, pinterest, playstation, posthog, replicate, renault, resend, revolut, runwayml, sanity, sentry, shopify, spacex, spotify, starbucks, stripe, supabase, superhuman, tesla, theverge, together.ai, uber, vercel, voltagent, vodafone, warp, webflow, wise, wired, x.ai, zapier, and others.
