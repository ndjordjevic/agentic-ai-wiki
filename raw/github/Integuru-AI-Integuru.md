...
- Fetched: 2026-07-08
- Final URL: https://github.com/Integuru-AI/Integuru
...
| Path | Type | Notes |
|---|---|---|
| `integuru/` | dir | Core agent package |
| `create_har.py` | file | Browser HAR capture utility for network request recording |
| `main.ipynb` | file | Jupyter notebook entry point |
| `tests/` | dir | pytest unit tests |
| `.github/` | dir | CI workflows (pytest on push/PR to main) |
| `pyproject.toml` | file | Poetry project config |
| `poetry.lock` | file | Locked dependencies |
| `LICENSE` | file | AGPL-3.0 |
| `integuru_demo.gif` | file | Demo animation |
