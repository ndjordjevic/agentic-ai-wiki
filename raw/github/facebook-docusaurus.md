...
- Default branch: main
- Latest release: 3.10.1 (2026-04-30)
- License: MIT License
- Homepage: https://docusaurus.io
- Fetched: 2026-07-08
- Final URL: https://github.com/facebook/docusaurus
...
Monorepo managed with Lerna and pnpm workspaces. Key directories:

- `packages/` — core Docusaurus packages (`@docusaurus/core`, preset-classic, content plugins, themes)
- `examples/` — starter templates (classic, blog-only, etc.)
- `website/` — Docusaurus project's own documentation site source
- `admin/` — internal admin tooling and assets
- `__tests__/` / `test/` — test suites
- `argos/` — visual regression testing (Argos CI)
- `AGENTS.md` — agent contributor instructions
- `CONTRIBUTING.md` — contribution guide
- `CHANGELOG.md` / `CHANGELOG-v2.md` — release history
