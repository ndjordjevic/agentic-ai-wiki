...
## Metadata
- Stars: 1977
- Primary language: none (Markdown/skill-based)
- Default branch: main
- Latest release: none
- License: MIT
- Homepage: (none)
- Fetched: 2026-06-12
- Final URL: https://github.com/shadcn/improve
...
## Top-level structure
- `.claude-plugin/` — Claude Code plugin manifest (`plugin.json`): name, description, author, homepage, license, keywords
- `LICENSE.md` — MIT license
- `README.md` — full usage documentation
- `examples/` — one example plan output: `001-extract-shadow-config-resolution.md` (plan against shadcn/ui demonstrating the output format with verification gates and STOP conditions)
- `skills/` — skill implementation files
  - `skills/improve/SKILL.md` — main skill definition (the advisor logic, audit categories, plan format)
  - `skills/improve/references/` — supporting reference files for the skill

## Docs
(No separate docs/ directory. Full documentation is in README.md above.)
...
```json
{
  ...
  "version": "1.0.0",
  "author": {"name": "shadcn", "url": "https://twitter.com/shadcn"},
