...
## Fetch log
- Inbox URL: https://x.com/trq212/status/2052809885763747935?s=43&t=5l2OHSF10JbahgpENs1smw
- Final URL: https://claude.com/blog/using-claude-code-the-unreasonable-effectiveness-of-html
- Fetched: 2026-07-07
- Pages: 1
- Mode: single-page
- Note: X status links to an X Article (x.com/i/article/2052796100608974848); direct fetch returned 403. Full article content captured from canonical Anthropic blog post. Examples gallery at https://thariqs.github.io/html-effectiveness. No llms.txt, docs discovery, or companion discovery (single-page article mode).

## Page — https://claude.com/blog/using-claude-code-the-unreasonable-effectiveness-of-html

Title: Using Claude Code: The unreasonable effectiveness of HTML | Claude by Anthropic
...
To make this approach more concrete, below are some example use cases where I think using HTML files make more sense than Markdown. You can also follow along with a GitHub gallery of these use cases, here (https://thariqs.github.io/html-effectiveness).
