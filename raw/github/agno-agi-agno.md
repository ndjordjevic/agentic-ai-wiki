...
- Default branch: main
- Latest release: v2.8.5 (2026-07-27)
- License: Apache License 2.0
- Homepage: https://docs.agno.com
- Fetched: 2026-07-28
- Final URL: https://github.com/agno-agi/agno
...
Not fetched in detail at `standard` companion-fetch depth — README and metadata are the primary source for this ingest. The README's "Get started" flow indicates the actual application code lives in separate deploy-template repos (`agentos-railway`, `agentos-docker`, `agentos-aws`, etc., all under `agno-agi/`) rather than in this repo's own top-level tree; this repo is the core SDK/runtime library (installed as the `agno` Python package).
