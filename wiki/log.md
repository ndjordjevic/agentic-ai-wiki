...
## 2026-09-18 | ingest | Tencent-BrowserSkill | CLI + daemon + Chromium extension letting shell-capable agents drive the user's own logged-in browser, with Agent Window isolation, explicit tab borrowing, and human-in-the-loop handoff

- Created: wiki/sources/Tencent-BrowserSkill.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/github/README.md, inbox.md
...
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/docker-sbx-releases.md
...
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/github/README.md, inbox.md
- Related updates: litellm.ai, openrouter.ai, pydantic-pydantic-ai

## 2026-07-21 | ingest | topoteretes-cognee | Open-source AI memory platform — knowledge graph + vector memory, unifiable on a single Postgres instance

- Created: wiki/sources/topoteretes-cognee.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/github/README.md, inbox.md
...
## 2026-07-09 | ingest | GoogleCloudPlatform-knowledge-catalog | Google Cloud Knowledge Catalog: OKF spec, reference enrichment agent, metadata-as-code toolbox, discovery/enrichment samples

- Created: wiki/sources/GoogleCloudPlatform-knowledge-catalog.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/github/README.md, inbox.md
...
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/facebook-docusaurus.md
...
## 2026-07-07 | ingest | streamlit.io | Python data-app framework — scripting UI, Session State, Community Cloud

- Created: wiki/sources/streamlit.io.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/streamlit-streamlit.md
...
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/firecrawl-firecrawl.md

## 2026-07-06 | ingest | marketstack.com | REST stock market & EDGAR filings API (APILayer)

- Created: wiki/sources/marketstack.com.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, inbox.md

## 2026-07-06 | ingest | pushover.net | hosted push-notification API for mobile/desktop alerts

- Created: wiki/sources/pushover.net.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, inbox.md
...
## 2026-07-06 | ingest | Yeachan-Heo-oh-my-claudecode | Claude Code plugin — hook-driven skill routing, 19 agents, team orchestration, magic keywords

- Created: wiki/sources/Yeachan-Heo-oh-my-claudecode.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/github/README.md, inbox.md
...
## 2026-07-03 | ingest | stitch.withgoogle.com | Google Labs vibe-design tool — text/sketch-to-UI, Figma export, DESIGN.md spec origin

- Created: wiki/sources/stitch.withgoogle.com.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, inbox.md

## 2026-07-03 | ingest | trigger.dev | Open-source TypeScript platform for durable AI agents and long-running workflows (checkpoint-resume, MCP)

- Created: wiki/sources/trigger.dev.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/triggerdotdev-trigger.dev.md
...
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/gitroomhq-postiz-app.md
...
## 2026-06-18 | ingest | pipedrive.com | Sales CRM and pipeline management platform with AI Sales Assistant, email marketing, REST API, and 500+ Marketplace integrations

- Created: wiki/sources/pipedrive.com.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, inbox.md
...
## 2026-06-12 | ingest | mattpocock-skills | Matt Pocock's 15-skill engineering collection (126k stars) — TDD, grilling, domain language, architecture improvement; distributed via skills.sh

- Created: wiki/sources/mattpocock-skills.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/github/README.md, inbox.md

## 2026-06-12 | ingest | supermemory.ai | Memory + context infrastructure for AI agents — 5-layer API, Knowledge Graph, hybrid RAG, MCP server, benchmarks: LongMemEval 85.2% / LoCoMo #1

- Created: wiki/sources/supermemory.ai.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, inbox.md
...
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/NousResearch-hermes-agent.md
...
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/pytorch-pytorch.md
...
## 2026-05-13 | ingest | planana.xyz | Planana AI — personal AI tutor that converts learning goals into structured weekly study roadmaps (free, web)

- Created: wiki/sources/planana.xyz.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, inbox.md
...
## 2026-05-02 | ingest | tmux-tmux | tmux — the canonical Unix terminal multiplexer (C, 45k stars, ISC License, v3.6a)

- Created: wiki/sources/tmux-tmux.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/github/README.md, inbox.md

---

## 2026-05-02 | ingest | tmuxai.dev | TmuxAI — AI-powered non-intrusive terminal assistant for tmux (Go, 1.8k stars, Apache-2.0, v2.1.4)

- Created: wiki/sources/tmuxai.dev.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/alvinunreal-tmuxai.md

---

## 2026-05-02 | ingest | njbrake-agent-of-empires | Agent of Empires — Rust session manager for parallel AI coding agents (TUI + web dashboard + remote access)

- Created: wiki/sources/njbrake-agent-of-empires.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/github/README.md, inbox.md
...
- Updated: wiki/sources/langchain.com.md, wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, inbox.md
- Raw: raw/web/langchain.com.md
- INFO: refresh: langchain.com | new sub-page: langchain.com-deepagents (Deep Agents SDK discovered in new llms.txt)

---

## 2026-04-29 | refresh | langchain.com | content updated

- Updated: wiki/sources/langchain.com.md, wiki/sources/langchain.com-langsmith.md, wiki/sources/langchain.com-fleet.md, wiki/sources/langchain.com-langchain.md, wiki/sources/langchain.com-langgraph.md, wiki/index.md, wiki/overview.md, wiki/log.md
- Raw: raw/web/langchain.com.md

---

## 2026-04-29 | ingest | langchain.com | multi-product (4 products): LangSmith, Fleet, LangChain, LangGraph

- Created: wiki/sources/langchain.com.md, wiki/sources/langchain.com-langsmith.md, wiki/sources/langchain.com-fleet.md, wiki/sources/langchain.com-langchain.md, wiki/sources/langchain.com-langgraph.md
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, inbox.md
...
- Updated: wiki/index.md, wiki/overview.md, wiki/log.md, raw/web/README.md, raw/github/README.md, inbox.md
- Companion: raw/github/paperclipai-paperclip.md
